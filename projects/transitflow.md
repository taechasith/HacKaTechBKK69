...
## 📝 English Summary
A multi-modal public transit route planner for Bangkok residents to coordinate bus, train, and boat commutes.

## 🇹🇭 Thai Summary / บทคัดย่อภาษาไทย
ระบบคำนวณและวางแผนเส้นทางเดินรถสาธารณะหลายรูปแบบ (Multi-modal) ในกรุงเทพมหานคร
